...
class echobot:
    ...
    def getUpdate(self):
        ...
        if result.status_code in self.good_codes:
            return result.json()
    ...
    def send_msg(root_url: str, good_codes: tuple, token1: str, chat_id: int,
                 msg: object):
...
class Parser:
    ...
    def check_word(sentences: dict, word: str, usrlvl: int, chat_id: int,
